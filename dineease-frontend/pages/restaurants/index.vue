<template>
  <div class="flex-col flex">
    <div v-if="restaurants.length && !isLoading" class="flex items-center justify-between space-y-2 mb-4">
    ...
    <div v-if="isLoading">
      <!-- Use the SkeletonLoader component -->
      <SkeletonLoader :columns="2" item-width="300px" item-height="150px" text-width="250px" text-height="16px" :itemsCount="6" />
    </div>
